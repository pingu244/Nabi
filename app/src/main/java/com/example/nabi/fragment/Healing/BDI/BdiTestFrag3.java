...
public class BdiTestFrag3 extends Fragment {

    private Integer score, cnt_1, cnt_2, cnt_3, cnt_4;
    // 프래그먼트간의 이동 위한 인스턴스 생성
    public static BdiTestFrag3 newInstance() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        button1 = view.findViewById(R.id.q3_score_0);
        button2 = view.findViewById(R.id.q3_score_1);
        button3 = view.findViewById(R.id.q3_score_2);
        button4 = view.findViewById(R.id.q3_score_3);
        ...
        bdi_3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId){
                    case R.id.q3_score_0:
//                        score+=0;
                        ((Healing_BdiTest)getActivity()).score[2] = 0;
//                        cnt_1++;
                        ((Healing_BdiTest)getActivity()).cnt[2] = 1;
                        break;

                    case R.id.q3_score_1:
//                        score+=1;
                        ((Healing_BdiTest)getActivity()).score[2] = 1;
//                        cnt_2++;
                        ((Healing_BdiTest)getActivity()).cnt[2] = 2;

                        break;

                    case R.id.q3_score_2:
//                        score+=2;
                        ((Healing_BdiTest)getActivity()).score[2] = 2;
//                        cnt_3++;
                        ((Healing_BdiTest)getActivity()).cnt[2] = 3;
                        break;

                    case R.id.q3_score_3:
//                        score+=3;
                        ((Healing_BdiTest)getActivity()).score[2] = 3;
//                        cnt_4++;
                        ((Healing_BdiTest)getActivity()).cnt[2] = 4;
                        break;
                }
            }
        });
...
//                BdiTestFrag4 fragment4 = new BdiTestFrag4();//프래그먼트2 선언
//                fragment4.setArguments(bundle);//번들을 프래그먼트2로 보낼 준비
//                transaction.replace(R.id.bdi_test_frag, fragment4);
...
//        }
        ...
        return inflater.inflate(R.layout.healing_bdi_test_3, container, false);
