...
//                        score+=0;
                        ((Healing_BdiTest)getActivity()).score[10] = 0;
//                        cnt_1++;
                        ((Healing_BdiTest)getActivity()).cnt[10] = 1;
                        break;

                    case R.id.q11_score_1:
//                        score+=1;
                        ((Healing_BdiTest)getActivity()).score[10] = 1;
//                        cnt_2++;
                        ((Healing_BdiTest)getActivity()).cnt[10] = 2;
                        break;

                    case R.id.q11_score_2:
//                        score+=2;
                        ((Healing_BdiTest)getActivity()).score[10] = 2;
//                        cnt_3++;
                        ((Healing_BdiTest)getActivity()).cnt[10] = 3;
                        break;

                    case R.id.q11_score_3:
//                        score+=3;
                        ((Healing_BdiTest)getActivity()).score[10] = 3;
//                        cnt_4++;
                        ((Healing_BdiTest)getActivity()).cnt[10] = 4;
                        break;
                }
            }
        });
