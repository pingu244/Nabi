...
public class BdiTestFrag10 extends Fragment {
    ...
    public static BdiTestFrag10 newInstance() {
        return new BdiTestFrag10();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button tenth_previous = getActivity().findViewById(R.id.tenth_previous);
...
//                        score+=0;
                        ((Healing_BdiTest)getActivity()).score[9] = 0;
//                        cnt_1++;
                        ((Healing_BdiTest)getActivity()).cnt[9] = 1;
                        break;

                    case R.id.q10_score_1:
//                        score+=1;
                        ((Healing_BdiTest)getActivity()).score[9] = 1;
//                        cnt_2++;
                        ((Healing_BdiTest)getActivity()).cnt[9] = 2;
                        break;

                    case R.id.q10_score_2:
//                        score+=2;
                        ((Healing_BdiTest)getActivity()).score[9] = 2;
//                        cnt_3++;
                        ((Healing_BdiTest)getActivity()).cnt[9] = 3;
                        break;

                    case R.id.q10_score_3:
//                        score+=3;
                        ((Healing_BdiTest)getActivity()).score[9] = 3;
//                        cnt_4++;
                        ((Healing_BdiTest)getActivity()).cnt[9] = 4;
                        break;
                }
            }
        });
...
//                transaction.commit();
        ...
        tenth_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((Healing_BdiTest)getActivity()).replaceFragment("page9",BdiTestFrag9.newInstance());
            }
        });
    }
