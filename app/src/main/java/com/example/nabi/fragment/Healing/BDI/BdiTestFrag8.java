...
public class BdiTestFrag8 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button eighth_previous = getActivity().findViewById(R.id.eighth_previous);
...
//                        score+=0;
                        ((Healing_BdiTest)getActivity()).score[7] = 0;
//                        cnt_1++;
                        ((Healing_BdiTest)getActivity()).cnt[7] = 1;
                        break;

                    case R.id.q8_score_1:
//                        score+=1;
                        ((Healing_BdiTest)getActivity()).score[7] = 1;
//                        cnt_2++;
                        ((Healing_BdiTest)getActivity()).cnt[7] = 2;
                        break;

                    case R.id.q8_score_2:
//                        score+=2;
                        ((Healing_BdiTest)getActivity()).score[7] = 2;
//                        cnt_3++;
                        ((Healing_BdiTest)getActivity()).cnt[7] = 3;
                        break;

                    case R.id.q8_score_3:
//                        score+=3;
                        ((Healing_BdiTest)getActivity()).score[7] = 3;
//                        cnt_4++;
                        ((Healing_BdiTest)getActivity()).cnt[7] = 4;
                        break;
                }
            }
        });
...
//                transaction.commit();
        ...
        eighth_previous.setOnClickListener(new View.OnClickListener() {
            @Override
