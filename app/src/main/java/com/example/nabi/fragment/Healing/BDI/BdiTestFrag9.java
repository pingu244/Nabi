...
public class BdiTestFrag9 extends Fragment {
    ...
    public static BdiTestFrag9 newInstance() {
        return new BdiTestFrag9();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button ninth_previous = getActivity().findViewById(R.id.ninth_previous);
...
//                        score+=0;
                        ((Healing_BdiTest)getActivity()).score[8] = 0;
//                        cnt_1++;
                        ((Healing_BdiTest)getActivity()).cnt[8] = 1;
                        break;

                    case R.id.q9_score_1:
//                        score+=1;
                        ((Healing_BdiTest)getActivity()).score[8] = 1;
//                        cnt_2++;
                        ((Healing_BdiTest)getActivity()).cnt[8] = 2;
                        break;

                    case R.id.q9_score_2:
//                        score+=2;
                        ((Healing_BdiTest)getActivity()).score[8] = 2;
//                        cnt_3++;
                        ((Healing_BdiTest)getActivity()).cnt[8] = 3;
                        break;

                    case R.id.q9_score_3:
//                        score+=3;
                        ((Healing_BdiTest)getActivity()).score[8] = 3;
//                        cnt_4++;
                        ((Healing_BdiTest)getActivity()).cnt[8] = 4;
                        break;
                }
            }
        });
...
//                transaction.commit();
        ...
        ninth_previous.setOnClickListener(new View.OnClickListener() {
            @Override
