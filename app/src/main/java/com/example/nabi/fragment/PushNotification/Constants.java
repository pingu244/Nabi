...
public class Constants {
    ...
    public static final Integer A_NIGHT_EVENT_TIME = 22;
    public static final Integer B_MORNING_EVENT_TIME = 0;
    public static final Integer B_NIGHT_EVENT_TIME = 8;

    // 푸시알림 허용 Interval 시간
    public static final Integer NOTIFICATION_INTERVAL_HOUR = 1;

    // 백그라운드 work Unique 이름
    public static final String WORK_A_NAME = "Next Weather Notification";
    public static final String WORK_B_NAME = "midnight DBpush";
}
